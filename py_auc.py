...
class AUC(object):
    ...
    def plot_ROC(self, bins=50, filename=''):
        ...
        # score distribution
        ax2 = axs[2]
        sns.histplot(self._spm.loc[self._spm['Class']==0, 'Score'], bins=bins, label='Class 0')
        sns.histplot(self._spm.loc[self._spm['Class']==1, 'Score'], bins=bins, label='Class 1')
...
class Score_generator(object):
    ...
    def plot_hist(self, filename='', show=True):
        ...
        sns.histplot(self._s0, bins=bins, norm_hist=True, label='Class 0 (#={})'.format(self._n0))
        sns.histplot(self._s1, bins=bins, norm_hist=True, label='Class 1 (#={})'.format(self._n1))
